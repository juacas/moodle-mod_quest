...
$string['answersubmission_help'] = '<P align="justify">Esta p&aacute;gina permite responder al desaf&iacute;o. </P>
...
$string['assessthissubmission'] = 'Evaluar este Desafío/Pregunta';
...
$string['calificationdate'] = 'Fecha Publicación de Notas';
$string['calificationdateevent'] = 'Publicación de las Notas de {$a}';
$string['calificationthisquest'] = 'Obtener las Notas del Módulo QUESTOURnament';
$string['calification_provisional_msg'] = 'La calificación mostrada puede ser provisional';
$string['challengestart'] = 'Fecha de comienzo del desafío';
...
$string['changecalification'] = 'Cambiar Calificación';
...
$string['confirmchangeform'] = 'Particularizar el formulario de elementos';
$string['comment'] = 'Comentario';
$string['commentby'] = 'Comentado por';
$string['comentsforautor'] = 'Comentarios para el Autor';
$string['comentsforpupil'] = 'Comentarios para Alumnos';
$string['commentsautor'] = 'Comentario General del Autor';
...
$string['doyouwantparticularform'] = '¿Quieres particularizar el formulario de elementos de corrección para este desafío?';
...
$string['finalcalification'] = 'Calificación Total';
$string['finalcalifications'] = 'Calificaciones Finales';
$string['finalcalificationuser'] = 'Calificación Final';
...
$string['global_help'] = '<P align="justify">Esta opción muestra la clasificaci&oacute;n de los participantes en el m&oacute;dulo QUESTOURnament que pertenezcan a un mismo grupo.</P>
<P align="justify">Los par&aacute;metros que se muestran son los siguientes:</P>
<div align="justify">
  <ul>
    <li><strong>Foto</strong>: imagen del alumno introducida por él en su perfil. </li>
      <li><strong>Nombre/Apellido</strong>: nombre y apellido del alumno introducidos por &eacute;l al registrarse en el sistema.</li>
      <li><strong>N&ordm; Resp.</strong>: n&uacute;mero de respuestas realizadas por el alumno en este m&oacute;dulo QUESTOURnament.</li>
      <li><strong>N&ordm; Resp. Eval.</strong>: n&uacute;mero de respuestas evaluadas de todas las enviadas por este alumno en este m&oacute;dulo QUESTOURnament.</li>
      <li><strong>N&ordm; Desaf&iacute;os </strong>: n&uacute;mero de desaf&iacute;os propuestos en el m&oacute;dulo QUESTOURnament por el alumno.</li>
      <li><strong>N&ordm; Desaf&iacute;os Eval.</strong>: n&uacute;mero de desaf&iacute;os evaluados de todos los propuestos por el alumno en este m&oacute;dulo QUESTOURnament.</li>
      <li><strong>Punt. Desaf&iacute;os</strong>: indica la puntuación total obtenida por el alumno correspondiente a la evaluaci&oacute;n, por parte de los profesores, de los desaf&iacute;os propuestos por dicho alumno.</li>
      <li><strong>Punt. Resp.</strong>: indica la puntuaci&oacute;n total obtenida por el alumno correspondiente a la evaluaci&oacute;n de las respuestas por &eacute;l enviadas.</li>
      <li><strong>Punt. Equipos</strong>: este par&aacute;metro s&oacute;lo se muestra en caso de tener en el m&oacute;dulo QUESTOURnament habilitada la opci&oacute;n de <a href="help.php?component=quest&identifier=allowteams"">Permitir Equipos</a>. Indica el porcentaje, fijado a trav&eacute;s de la opción <a href="help.php?component=quest&identifier=teamporcent"">Porcentaje en la Calificaci&oacute;n de los Equipos</a>, de la puntuaci&oacute;n total obtenida por el equipo al que pertenece el alumno, en su puntuación individual.</li>
      <li><strong>Puntuaci&oacute;n</strong>: recoge la suma de las puntuaciones correspondientes a los desaf&iacute;os propuestos por los alumnos y a las respuestas enviadas por &eacute;stos. </li>
  </ul>
    <p>Hay que puntualizar que los profesores tienen acceso a toda la información anterior, mientras que los alumnos sólo verán dicha información en cado de que el creador del QUESTOURnament haya seleccionado la opción <a href="help.php?component=quest&identifier=showauthoringdetails"">Mostrar a los Alumnos detalles de los Autores en la Clasificación</a>. En caso contrario, los alumnos no podrán visualizar los datos parciales relativos a los desafíos propuestos por sus compañeros.</p>
...
$string['gradingstrategyautor'] = 'Estrategia de Calificación Autores';
...
$string['mycalification'] = 'Mi Clasificación';
$string['mycalificationteam'] = 'Mi Clasificación por Equipos';
$string['myplace'] = 'Mi Sitio';
$string['mysubmissions'] = 'Mis Desafíos';
...
$string['nivel'] = 'Nivel de Exigencia';
$string['nmaxanswers'] = 'Número Máximo de Respuestas Correctas por Desafío';
...
$string['notpermissionanswer'] = 'No se puede mostrar la respuesta solicitada';
...
$string['notsubmittedanswers'] = 'No hay Respuestas Enviadas';
...
$string['numbercomponents'] = 'Número de Componentes';
$string['numbermaxofanswers'] = 'Número Máximo de Respuestas';
$string['numberofassessmentelements'] = 'Número de elementos de Evaluación';
$string['numberofassessmentelementsautor'] = 'Número de Elementos de Evaluación para Autores';
...
$string['of'] = 'de';
$string['oldcalification'] = 'Calificación Actual';
...
$string['allowresubmission'] = 'Permitir enviar de nuevo';
$string['answeragain'] = 'Responder de nuevo';
$string['permitviewautors'] = '¿Mostrar a los alumnos los autores de los Desafíos una vez cerrados?';
...
$string['questgraphYlegend'] = 'Puntos';
$string['questpassessments'] = 'Evaluaciones del módulo QUESTOURnament';
$string['questpfeedback'] = 'Comentarios de feedback al módulo QUESTOURnament';
$string['questsubmissions'] = 'Envíos al módulo QUESTOURnament';
...
$string['seeassessmentautor'] = 'Ver Evaluación del Desafío';
...
$string['showauthoringdetails'] = 'Mostrar detalles de autores en clasificación a alumnos.';
...
$string['submissionend'] = 'Fecha de Cierre del Desafío {$a}';
$string['submissionexisty'] = 'Ya existe un Desafío con el mismo Nombre. Introducir otro título';
$string['submissions'] = 'Desafíos';
$string['submissionsnolongerallowed'] = 'No se permiten más envíos de desafíos';
$string['submissionsnoauthorizedupdate'] = 'No puede modificar este desafío.';
...
$string['teamporcent'] = 'Porcentaje Calificación Equipos';
...
$string['upgradecalification'] = 'Obtener Calificaciones';
$string['uploadsuccess'] = 'Anexos Enviados';
$string['uploaderror'] = 'Fallo al env�ar anexos';
...
$string['weight'] = 'Peso';
$string['weightederrorcount'] = 'Suma ponderada del error: {$a}';
...
$string['windowpreview'] = 'Vista de Previsualización de la Respuesta';
$string['windowpreviewsubmission'] = 'Vista de Previsualización del Desafío';
...
$string['global'] = 'Ver Clasificaci&oacute;n Total';
$string['global_help'] = '<P align="justify">Esta opción muestra la clasificaci&oacute;n de los participantes en el m&oacute;dulo QUESTOURnament que pertenezcan a un mismo grupo.</P>
<P align="justify">Los par&aacute;metros que se muestran son los siguientes:</P>
<div align="justify">
  <ul>
...
<P align="justify">La estrategia de evaluación utilizada para evaluar las respuestas enviadas a los desafíos planteados en un módulo QUESTOURnament es acumulativa.
...
';
$string['windowpreview'] = 'Ventana de Previsualizaci&oacute;n de la Respuesta';
$string['windowpreview_help'] = '<p align="justify">Esta página muestra el aspecto que tiene el desaf&iacute;o que se está editando en el editor de Moodle después de aplicarse los distintos filtros que proporciona dicha plataforma.</p>
...
';
$string['windowpreviewsubmission'] = 'Ventana de Previsualizaci&oacute;n del Desaf&iacute;o';
$string['windowpreviewsubmission_help'] = '<p align="justify">Esta página muestra el aspecto que tiene el desaf&iacute;o que se está editando en el editor de Moodle después de aplicarse los distintos filtros que proporciona dicha plataforma.</p>
<p align="justify">De esta manera se podr&aacute; comprobar el aspecto de un desaf&iacute;o antes de añadirlo. Esta posibilidad resulta sobre todo útil cuando se necesite introducir una ecuación matem&aacute;tica para lo cuál se tendr&aacute; que utilizar una expresión con el formato adecuado que transformar&aacute;n los filtros que proporciona Moodle y cuyo aspecto final no puede visualizarse en el editor de dicha plataforma.</p>
';
...
// Strings added for the current Quest features.
$string['pluginname'] = 'QUESTOURnament';
$string['questournament'] = 'QUESTOURnament';
$string['addchallenge'] = 'Añadir reto';
$string['addquestionchallenge'] = 'Añadir reto con pregunta';
$string['author'] = 'Autor';
$string['commentsforauthor'] = 'Comentarios para el autor';
$string['commentsforstudent'] = 'Comentarios para el estudiante';
...
$string['authorpoints'] = 'Puntos del autor';
$string['rank'] = 'Posición';
$string['challenges'] = 'Retos';
$string['nochallenges'] = 'No hay retos disponibles';
$string['nostudentsyet'] = 'Todavía no hay estudiantes';
$string['cards'] = 'Tarjetas';
$string['list'] = 'Lista';
$string['cardview'] = 'Vista de tarjetas';
$string['listview'] = 'Vista de lista';
$string['summary'] = 'Resumen';
$string['currentscore'] = 'Puntuación actual';
$string['javascriptrequired'] = 'Se necesita JavaScript para mostrar este gráfico.';
$string['phase_stationary'] = 'Fase estacionaria';
$string['phase_inflation'] = 'Fase de crecimiento';
$string['phase_deflation'] = 'Fase de descenso';
$string['closed'] = 'Cerrado';
$string['approvalpending'] = 'Pendiente de aprobación';
$string['challenge_not_evaluated'] = 'No evaluado';
$string['back'] = 'Volver';
$string['adjustchallenge'] = 'Ajusta desafío';
$string['editquestion'] = 'Editar pregunta';
$string['reorderchallenges'] = 'Programar retos';
$string['reorderchallengestitle'] = 'Programación y línea temporal de retos';
$string['reorderchallengesdesc'] = 'Arrastre los retos o sus extremos de inicio y fin para programarlos dentro del periodo del torneo.';
$string['schedulesaved'] = 'La programación de retos se ha guardado correctamente.';
$string['autosequence'] = 'Secuenciar automáticamente';
$string['autosequencetitle'] = 'Secuenciar retos';
$string['choosestrategy'] = 'Seleccionar método de secuenciación';
$string['apply'] = 'Aplicar';
$string['strategy_equal'] = 'Distribución equitativa';
$string['strategy_equal_short'] = 'Repartir por igual el tiempo del torneo';
$string['strategy_equal_desc'] = 'Divide por igual el tiempo del torneo entre todos los retos en orden cronológico.';
$string['strategy_equal_tip'] = 'Ideal cuando todos los retos deben disponer de un tiempo similar.';
$string['strategy_sequential'] = 'Encadenamiento secuencial';
$string['strategy_sequential_short'] = 'Encadenar retos conservando su duración';
$string['strategy_sequential_desc'] = 'Coloca los retos uno detrás de otro sin huecos ni solapamientos, conservando sus duraciones cuando es posible.';
$string['strategy_sequential_tip'] = 'Útil cuando cada reto ya tiene la duración deseada.';
$string['strategy_proportional'] = 'Proporcional acotado';
$string['strategy_proportional_short'] = 'Repartir el tiempo según las duraciones actuales';
$string['strategy_proportional_desc'] = 'Asigna el tiempo del torneo proporcionalmente a las duraciones actuales, limitando los valores extremos.';
$string['strategy_proportional_tip'] = 'Útil cuando algunos retos necesitan más tiempo que otros.';
$string['resetschedule'] = 'Restablecer programación';
$string['unsavedchanges'] = 'Tiene cambios sin guardar.';
$string['nosubmissionsfound'] = 'No se encontraron retos para programar.';
$string['durationdays'] = '{$a} días';
$string['durationhours'] = '{$a} horas';
$string['schedulelegend'] = 'Leyenda de la línea temporal';
$string['nochallengesfound'] = 'No se encontraron retos';
$string['scheduleerrorinvaliditem'] = 'Elemento de programación de reto no válido.';
$string['scheduleerrornotfound'] = 'No se encontró el reto {$a} en este torneo.';
$string['scheduleerrordatesinvalid'] = 'Fechas no válidas para el reto «{$a}»: la fecha final debe ser posterior a la inicial.';
$string['scheduleerroranswerbeforestart'] = 'El reto «{$a->title}» ya tiene respuestas enviadas el {$a->date}. No se puede mover la fecha inicial después de ese momento.';
$string['scheduleerroranswerafterend'] = 'El reto «{$a->title}» tiene respuestas enviadas el {$a->date}. No se puede mover la fecha final antes de ese momento.';
$string['scheduleerroranswercorrect'] = 'El reto «{$a->title}» tiene una respuesta correcta verificada el {$a->date}. La programación debe incluir esa fecha.';
$string['scheduleboundaryexpanded'] = 'Las fechas del torneo se han sincronizado con los retos ({$a->start} - {$a->end}).';
$string['schedulesavedcount'] = 'Programación guardada correctamente ({$a} retos actualizados).';
$string['clicktoeditdate'] = 'Haga clic para editar la fecha';
$string['editdatesmodal'] = 'Editar fechas del reto';
$string['invaliddateorder'] = 'La fecha final debe ser posterior a la fecha inicial.';
$string['editdatesmodaltip'] = 'Los cambios no se guardarán hasta que pulse «Guardar cambios».';
$string['wrongteam'] = 'El equipo indicado no es válido.';
$string['commentsauthor'] = 'Comentarios generales del autor';
$string['answer_not_found'] = 'No se puede obtener la respuesta con identificador {$a}.';
