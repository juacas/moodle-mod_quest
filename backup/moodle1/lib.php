...
class moodle1_mod_quest_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        $paths = array(new convert_path('quest', '/MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST'),
                        ...
                        new convert_path('calification_team',
                                '/MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/CALIFICATIONS_TEAMS/CALIFICATION_TEAM'));
        return $paths;
    }
    ...
    public function process_quest($data) {
        ...
        $this->xmlwriter->begin_tag('activity',
                array('id' => $instanceid, 'moduleid' => $this->moduleid, 'modulename' => 'quest', 'contextid' => $contextid));
    ...
    public function on_submission_end() {
        $this->xmlwriter->end_tag('challenge');
    }

    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/SUBMISSIONS/SUBMISSION
     * data available */
    ...
    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/ELEMENTS/ELEMENT
     * data available */
    ...
    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/ELEMENTS_AUTOR/ELEMENT_AUTOR
     * data available */
    ...
    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/SUBMISSIONS/SUBMISSION/ANSWERS/ANSWER/ASSESSMENTS/ASSESSMENT/ELEMENTS_ASSESSMENT
     * data available */
    ...
    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/CALIFICATION_USERS
     * data available */
    ...
    /** This is executed every time we have one
     * /MOODLE_BACKUP/COURSE/MODULES/MOD/QUEST/CALIFICATION_TEAMS
     * data available */
