...
class answer_viewed extends base {
     ...
     * @param \cm_info $cm
     * @return \mod_quest\event\answer_viewed
     */
    public static function create_from_parts(\stdClass $user, \stdClass $challenge, \stdClass $answer, \cm_info $cm) {
        ...
        $event->set_legacy_logdata('view', $data['other']['info'], $url);
        return $event;
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' view the answer '" . $this->data['other']['info'] . "' in Questournament " .
                 $this->data['other']['activityid'] . "in the course '$this->courseid'. ";
    }
