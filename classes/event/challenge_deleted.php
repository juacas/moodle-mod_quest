...
class challenge_deleted extends base {
     ...
     * @param \cm_info $cm
     * @return \mod_quest\event\challenge_deleted
     */
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted a Challenge in the Quest activity '" . $this->data['other']['activityid'] .
