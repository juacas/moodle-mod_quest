...
//  $this->output();
// Da una oportunidad a decorar posteriormente el resultado llamar a output explícitamente
}
...
function get_y_point($ydata)
{
  if (isset($set) && isset($this->y_format[$set]['y_axis']) && $this->y_format[$set]['y_axis'] == 'right') {
          return  $this->calculated['boundary_box']['bottom']-round(($ydata - $this->calculated['y_axis_right']['min'])
              * $this->calculated['y_axis_right']['factor']);
        } else {
         return  $this->calculated['boundary_box']['bottom']- round(($ydata - $this->calculated['y_axis_left']['min'])
              * $this->calculated['y_axis_left']['factor']);
        }
}
